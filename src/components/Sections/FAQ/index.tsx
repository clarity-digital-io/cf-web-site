...
export default function FAQ() {
  return <div className="mx-auto max-w-7xl py-16 px-4 sm:py-24 sm:px-6 lg:px-8 bg-white">
    <h2 className="text-left text-4xl font-bold tracking-tight text-zinc-900">Frequently Asked Questions.</h2>
    <div className="mt-12">
