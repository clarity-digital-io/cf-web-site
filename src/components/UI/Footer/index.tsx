...
const navigation = {
  ...
  social: [
    {
      name: 'Twitter',
      href: 'https://twitter.com/clarityforms',
      icon: (props: any) => (
    ...
    {
      name: 'GitHub',
      href: 'https://github.com/clarity-digital-io',
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    <footer>
      ...
      <div className="bg-zinc-900 py-6">
        <div className="mx-auto max-w-6xl overflow-hidden px-4 sm:px-6 lg:px-8">
          <p className="text-center text-base text-zinc-300 font-mono"><span className="text-white font-bold font-sans">Clarity Forms</span> &copy; 2020 Clarity Digital Partners LLC. All rights reserved.</p>
        </div>
      </div>
